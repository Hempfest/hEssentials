...
public class InventoryClaimsList extends Pagination {

    Utils u;

    heHook api = heHook.getHook();

    public InventoryClaimsList(GuiLibrary gui) {
        super(gui);
    }

    @Override
    public String getMenuName() {
        return guiLibrary.getData2() + " | Claim list" + api.lib.color(" &d&oClick to locate.");
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (mat) {
            ...
            case GLOBE_BANNER_PATTERN:
                ...
                Bukkit.dispatchCommand(p, "claim find " + guiLibrary.getData());
                p.closeInventory();
                break;
            case BARRIER:
                p.closeInventory();
